...
libnyquist currently only exists as part of AudMonkey.  For
information on using libnyquist as an embedded audio processor
within another application, contact the AudMonkey developers:

  https://lists.sourceforge.net/lists/listinfo/audmonkey-devel 
