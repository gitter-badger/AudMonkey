/**********************************************************************
  ...
  to avoid naming problems. This early implementation from AudMonkey has
  been upated and the current AudMonkey version imports wxChar, but if I
  ...
  within AudMonkey. For now, at least, I'm just renaming functions, 
