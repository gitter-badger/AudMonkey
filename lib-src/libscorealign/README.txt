...
in MatLab. It was ported to C++. To incorporate this code into AudMonkey,
...
When scorealign is used in AudMonkey, a different subclass of Audio_reader
will call into AudMonkey using a Mixer object to retrieve samples from
selected tracks.
