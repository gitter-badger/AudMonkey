...
(defun audacity-version-ok (min-version)
  ;; No longer required as this plug-in is shipped with AudMonkey.
  ;; Left in for illustration purposes.
  ;; min-version is a list of three numbers (the minimum AudMonkey version number).
  ;; Example, if the minimum version required is AudMonkey 2.4.0, then
