# This CMake script is invoked to build the InnoSetup installer for AudMonkey
...
configure_file("${OUTPUT_DIR}/audmonkey.iss.in" "${OUTPUT_DIR}/audmonkey.iss")
...
execute_process(
    COMMAND
        ${INNO_SETUP_COMPILER} /Sbyparam=$p "audmonkey.iss"
    WORKING_DIRECTORY
        ${OUTPUT_DIR}
)
