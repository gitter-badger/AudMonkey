...
added into the standard AudMonkey Project Menus.
...
static CommandHandlerObject &ident(AudMonkeyProject&project)
{
...
// This is the function that connects us to AudMonkey.
...
{
   ix=ix;//compiler food
   // If we wanted to hide AudMonkey's Project, 
