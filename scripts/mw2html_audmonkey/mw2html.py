...
Improved filtering.
Improved usability.
Customized for AudMonkey's manual wiki.
Minor tweaks (for AudMonkey) By James Crook, Nov 2009.
...
errors = 0
conn = None
headers = {"User-Agent": "mw2html.py/AudMonkey"}
domain = ''
...
def monobook_fix_html(doc, page_url):
    ...
    doc = re.sub(r'AudMonkey Development Manual</title>', r'AudMonkey Manual</title>', doc )
...
def run(out=sys.stdout):
    ...
    deploy_file( "AudMonkeyLogo.png", r"alphamanual.audacityteam.org/m/resources/assets/AudMonkeyLogo.png")
