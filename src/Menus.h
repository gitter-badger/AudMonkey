...
**********************************************************************/
#ifndef __AUDMONKEY_MENUS__
#define __AUDMONKEY_MENUS__
...
class AUDMONKEY_DLL_API MenuCreator
{
public:
   MenuCreator();
   ~MenuCreator();
   void CreateMenusAndCommands(AudMonkeyProject &project);
   void RebuildMenuBar(AudMonkeyProject &project);
...
class AUDMONKEY_DLL_API MenuManager final
   : public MenuCreator
...
public:
   ...
   static MenuManager &Get( AudMonkeyProject &project );
   static const MenuManager &Get( const AudMonkeyProject &project );

   explicit
   MenuManager( AudMonkeyProject &project );
   ...
   static void ModifyUndoMenuItems(AudMonkeyProject &project);
   static void ModifyToolbarMenus(AudMonkeyProject &project);
