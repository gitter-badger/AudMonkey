...
void DoMacMinimize(AudMonkeyProject *project)
{
   if (project) {
...
std::vector< std::weak_ptr< AudMonkeyProject > > sProjects;
...
wxWindowID ReservedID(
   size_t index, const std::shared_ptr< AudMonkeyProject > &pProject )
{
