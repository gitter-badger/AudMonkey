...
AudMonkeyProject::AttachedWindows::RegisteredFactory sMacrosWindowKey{
...
void DoManagePluginsMenu(AudMonkeyProject &project, EffectType type)
{
...
void OnAudMonkeyCommand(const CommandContext & ctx)
{
   // using GET in a log message for devs' eyes only
   wxLogDebug( "Command was: %s", ctx.parameter.GET());
   // Not configured, so prompt user.
   MacroCommands::DoAudMonkeyCommand(
...
BaseItemSharedPtr ExtraScriptablesIMenu()
{
   ...
   Menu( wxT("Scriptables1"), XXO("Script&ables I"),
      ...
      Command( wxT("SelectTime"), XXO("Select Time..."), FN(OnAudMonkeyCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("SelectFrequencies"), XXO("Select Frequencies..."),
         FN(OnAudMonkeyCommand),
         AudioIONotBusyFlag() ),
      ...
      Command( wxT("SetPreference"), XXO("Set Preference..."),
         FN(OnAudMonkeyCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("SetClip"), XXO("Set Clip..."), FN(OnAudMonkeyCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("SetEnvelope"), XXO("Set Envelope..."),
         FN(OnAudMonkeyCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("SetLabel"), XXO("Set Label..."), FN(OnAudMonkeyCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("SetProject"), XXO("Set Project..."), FN(OnAudMonkeyCommand),
         AudioIONotBusyFlag() )
   ) ) };
   return menu;
}
...
BaseItemSharedPtr ExtraScriptablesIIMenu()
{
   ...
   Menu( wxT("Scriptables2"), XXO("Scripta&bles II"),
      Command( wxT("Select"), XXO("Select..."), FN(OnAudMonkeyCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("SetTrack"), XXO("Set Track..."), FN(OnAudMonkeyCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("GetInfo"), XXO("Get Info..."), FN(OnAudMonkeyCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("Message"), XXO("Message..."), FN(OnAudMonkeyCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("Help"), XXO("Help..."), FN(OnAudMonkeyCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("Import2"), XXO("Import..."), FN(OnAudMonkeyCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("Export2"), XXO("Export..."), FN(OnAudMonkeyCommand),
         AudioIONotBusyFlag() ),
      ...
      Command( wxT("SaveProject2"), XXO("Save Project..."),
         FN(OnAudMonkeyCommand),
         AudioIONotBusyFlag() ),
      Command( wxT("Drag"), XXO("Move Mouse..."), FN(OnAudMonkeyCommand),
         AudioIONotBusyFlag() ),
