...
void DoSelectClipBoundary(AudMonkeyProject &project, bool next)
{
...
(AudMonkeyProject &project, const WaveTrack* wt, double t0, double t1)
{
...
void DoSelectClip(AudMonkeyProject &project, bool next)
{
   auto &selectedRegion = ViewInfo::Get( project ).selectedRegion;
   auto &trackFocus = TrackFocus::Get( project );
...
(AudMonkeyProject &project, bool next)
{
   auto &selectedRegion = ViewInfo::Get( project ).selectedRegion;
   auto &trackFocus = TrackFocus::Get( project );
   auto &window = ProjectWindow::Get( project );
...
double DoClipMove( AudMonkeyProject &project, Track *track,
...
(AudMonkeyProject &project, bool right, bool keyUp )
{
   ...
   if (amount != 0.0) {
      ...
      // entry in AudMonkey's history dialog.
...
{
   AudMonkeyProject &project = context.project;
