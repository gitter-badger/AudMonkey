...
{
public:
   static ProjectSettings &Get( AudMonkeyProject &project );
   static const ProjectSettings &Get( const AudMonkeyProject &project );
   ...
   explicit ProjectSettings( AudMonkeyProject &project );
