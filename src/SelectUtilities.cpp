...
void SelectNone( AudMonkeyProject &project )
{
   auto &tracks = TrackList::Get( project );
   for (auto t : tracks.Any())
      t->SetSelected(false);
...
void SelectAllIfNone( AudMonkeyProject &project )
{
...
bool SelectAllIfNoneAndAllowed( AudMonkeyProject &project )
{
...
(AudMonkeyProject &project, Track *t, bool shift, bool ctrl, bool modifyState)
{
   auto &tracks = TrackList::Get( project );
...
void DoSelectAll(AudMonkeyProject &project)
{
   DoSelectTimeAndTracks( project, true, true );
}

void DoSelectAllAudio(AudMonkeyProject &project)
{
...
void DoSelectSomething(AudMonkeyProject &project)
{
   auto &tracks = TrackList::Get( project );
   auto &selectedRegion = ViewInfo::Get( project ).selectedRegion;
