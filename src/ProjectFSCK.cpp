...
#pragma message( "====================================================================")
   ...
   if (bForceError && !bAutoRecoverMode)
   {
      ...
      /* i18n-hint: The audmonkey project file is XML and has 'tags' in it,
...
\n('aliased files'). There is no way for AudMonkey \
...
\nAudMonkey can fully regenerate these files \
...
\ndeletion. There is no way for AudMonkey to recover \
