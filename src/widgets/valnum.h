...
class AUDMONKEY_DLL_API NumValidatorBase /* not final */ : public wxValidator
{
public:
...
class AUDMONKEY_DLL_API IntegerValidatorBase /* not final */
...
class AUDMONKEY_DLL_API FloatingPointValidatorBase /* not final */
   : public NumValidatorBase
{
public:
...
AUDMONKEY_DLL_API double RoundValue(int precision, double value);
