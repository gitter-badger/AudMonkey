...
public:
   ...
   // Set and Get values of the version major/minor/micro keys in audmonkey.cfg when AudMonkey first opens
...
private:
   ...
   // values of the version major/minor/micro keys in audmonkey.cfg
   // when AudMonkey first opens
