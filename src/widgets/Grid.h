...
#ifndef __AUDMONKEY_WIDGETS_GRID__
#define __AUDMONKEY_WIDGETS_GRID__
...
class AUDMONKEY_DLL_API NumericEditor /* not final */ : public wxGridCellEditor
{
public:
...
class AUDMONKEY_DLL_API ChoiceEditor final
...
class AUDMONKEY_DLL_API Grid final : public wxGrid
{
