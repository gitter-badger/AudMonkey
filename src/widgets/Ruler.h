...
#ifndef __AUDMONKEY_RULER__
#define __AUDMONKEY_RULER__
...
class AUDMONKEY_DLL_API RulerPanel final : public wxPanelWrapper {
...
#endif //define __AUDMONKEY_RULER__
