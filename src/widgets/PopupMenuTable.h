...
#ifndef __AUDMONKEY_POPUP_MENU_TABLE__
#define __AUDMONKEY_POPUP_MENU_TABLE__
...
struct AUDMONKEY_DLL_API PopupMenuTableEntry : Registry::SingleItem
{
...
struct AUDMONKEY_DLL_API PopupSubMenu : Registry::ConcreteGroupItem< false >
   , MenuTable::WholeMenu
{
   TranslatableString caption;
...
class AUDMONKEY_DLL_API PopupMenuTable : public PopupMenuHandler
{
public:
