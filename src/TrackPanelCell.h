...
#ifndef __AUDMONKEY_TRACK_PANEL_CELL__
#define __AUDMONKEY_TRACK_PANEL_CELL__
...
class AUDMONKEY_DLL_API /* not final */ TrackPanelNode
...
class AUDMONKEY_DLL_API TrackPanelGroup /* not final */ : public TrackPanelNode
{
public:
   TrackPanelGroup();
...
class AUDMONKEY_DLL_API TrackPanelCell /* not final */ : public TrackPanelNode
{
public:
   ...
   virtual std::vector<UIHandlePtr> HitTest
      (const TrackPanelMouseState &state,
       const AudMonkeyProject *pProject) = 0;
   ...
   virtual unsigned DoContextMenu
      (const wxRect &rect,
       wxWindow *pParent, wxPoint *pPosition, AudMonkeyProject *pProject);
