...
public:
   ...
   virtual void Enter(bool forward, AudMonkeyProject *pProject);
   ...
   // Default does nothing and returns false
   virtual bool Escape(AudMonkeyProject *pProject);
   ...
   virtual Result Click
      (const TrackPanelMouseEvent &event, AudMonkeyProject *pProject) = 0;
   ...
   virtual HitTestPreview Preview
      (const TrackPanelMouseState &state, AudMonkeyProject *pProject) = 0;
   ...
   // Assume previously Clicked and not yet Released or Cancelled.
   // Cancelled in return flags has no effect.
   virtual Result Cancel(AudMonkeyProject *pProject) = 0;
   ...
   // use?
   virtual void OnProjectChange(AudMonkeyProject *pProject);
