...
{
public:
   static ProjectAudioManager &Get( AudMonkeyProject &project );
   static const ProjectAudioManager &Get( const AudMonkeyProject &project );

   // Find suitable tracks to record into, or return an empty array.
   static WaveTrackArray ChooseExistingRecordingTracks(
      AudMonkeyProject &proj, bool selectedOnly,
   ...
   explicit ProjectAudioManager( AudMonkeyProject &project );
   ...
   bool DoRecord(AudMonkeyProject &project,
