...
#ifndef __AUDMONKEY_SAMPLE_FORMAT__
#define __AUDMONKEY_SAMPLE_FORMAT__
...
extern AUDMONKEY_DLL_API DitherType gLowQualityDither, gHighQualityDither;
...
AUDMONKEY_DLL_API TranslatableString GetSampleFormatStr(sampleFormat format);
