...
{
public:
   static AdornedRulerPanel &Get( AudMonkeyProject &project );
   static const AdornedRulerPanel &Get( const AudMonkeyProject &project );
   static void Destroy( AudMonkeyProject &project );

   AdornedRulerPanel(AudMonkeyProject *project,
                     wxWindow* parent,
                     wxWindowID id,
...
private:
   ...
   Ruler mRuler;
   AudMonkeyProject *const mProject;
   TrackList *mTracks;
...
public:
   AudMonkeyProject * GetProject() const override;
private:
