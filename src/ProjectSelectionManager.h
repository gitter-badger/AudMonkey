...
{
public:
   static ProjectSelectionManager &Get( AudMonkeyProject &project );
   static const ProjectSelectionManager &Get( const AudMonkeyProject &project );

   explicit ProjectSelectionManager( AudMonkeyProject &project );
