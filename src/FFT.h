...
**********************************************************************/
#ifndef __AUDMONKEY_FFT_H__
#define __AUDMONKEY_FFT_H__
...
AUDMONKEY_DLL_API const TranslatableString WindowFuncName(int whichFunction);

/*
 * Returns the number of windowing functions supported
 */

AUDMONKEY_DLL_API int NumWindowFuncs();
