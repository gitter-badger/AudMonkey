...
class AUDACITY_DLL_API AllProjects
{
   ...
   static Container gAudMonkeyProjects;
...
public:
   ...
   value_type Remove( AudMonkeyProject &project );
...
using AttachedProjectObjects = ClientData::Site<
   AudMonkeyProject, ClientData::Base, ClientData::SkipCopying, std::shared_ptr
>;
...
class AUDACITY_DLL_API AudMonkeyProject final
   ...
   , public std::enable_shared_from_this<AudMonkeyProject>
{
 public:
...
inline wxFrame *FindProjectFrame( AudMonkeyProject *project ) {
   return project ? &GetProjectFrame( *project ) : nullptr;
}
inline const wxFrame *FindProjectFrame( const AudMonkeyProject *project ) {
   return project ? &GetProjectFrame( *project ) : nullptr;
}
