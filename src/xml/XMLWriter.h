...
**********************************************************************/
#ifndef __AUDMONKEY_XML_XML_FILE_WRITER__
#define __AUDMONKEY_XML_XML_FILE_WRITER__
...
/// XMLWriter
///
class AUDMONKEY_DLL_API XMLWriter /* not final */ {
...
class AUDMONKEY_DLL_API XMLFileWriter final : private wxFFile, public XMLWriter {
