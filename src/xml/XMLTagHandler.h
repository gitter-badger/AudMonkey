...
**********************************************************************/
#ifndef __AUDMONKEY_XML_TAG_HANDLER__
#define __AUDMONKEY_XML_TAG_HANDLER__
...
#include "XMLWriter.h"
class AUDMONKEY_DLL_API XMLValueChecker
{
public:
...
class AUDMONKEY_DLL_API XMLTagHandler /* not final */ {
 public:
   XMLTagHandler(){};
...
#endif // define __AUDMONKEY_XML_TAG_HANDLER__
