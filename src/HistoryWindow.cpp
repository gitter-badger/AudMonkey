...
HistoryDialog::HistoryDialog(AudMonkeyProject *parent, UndoManager *manager):
...
AudMonkeyProject::AttachedWindows::RegisteredFactory sHistoryWindowKey{
...
AttachedItem sAttachment{ wxT("View/Windows"),
   ...
   // in AudMonkeyProject::UpdateMenus() (ugly)
   ...
   // AudMonkeyProject::UpdateMenus(), if somebody decides to do it:
