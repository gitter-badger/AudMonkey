...
ScrubbingToolBar::ScrubbingToolBar( AudMonkeyProject &project )
...
ScrubbingToolBar &ScrubbingToolBar::Get( AudMonkeyProject &project )
{
   auto &toolManager = ToolManager::Get( project );
   return *static_cast<ScrubbingToolBar*>( toolManager.GetToolBar(ScrubbingBarID) );
}

const ScrubbingToolBar &ScrubbingToolBar::Get( const AudMonkeyProject &project )
{
