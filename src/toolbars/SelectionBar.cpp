...
SelectionBar::SelectionBar( AudMonkeyProject &project )
...
SelectionBar &SelectionBar::Get( AudMonkeyProject &project )
{
   auto &toolManager = ToolManager::Get( project );
   return *static_cast<SelectionBar*>( toolManager.GetToolBar(SelectionBarID) );
}

const SelectionBar &SelectionBar::Get( const AudMonkeyProject &project )
{
