...
TranscriptionToolBar::TranscriptionToolBar( AudMonkeyProject &project )
: ToolBar( project,
...
TranscriptionToolBar &TranscriptionToolBar::Get( AudMonkeyProject &project )
{
   auto &toolManager = ToolManager::Get( project );
   return *static_cast<TranscriptionToolBar*>( toolManager.GetToolBar(TranscriptionBarID) );
}

const TranscriptionToolBar &TranscriptionToolBar::Get( const AudMonkeyProject &project )
{
