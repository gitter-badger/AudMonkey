...
\brief An ImportFileHandle for MP3 data
  ...
  AudMonkey has finally moved to using a single mp3 library on all
...
public:
   ...
   std::unique_ptr<ImportFileHandle> Open(const FilePath &Filename, AudMonkeyProject*) override;
};
