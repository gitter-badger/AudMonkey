...
public:
   ...
   std::unique_ptr<ImportFileHandle> Open(
      const FilePath &Filename, AudMonkeyProject*) override;
};
...
std::unique_ptr<ImportFileHandle> FFmpegImportPlugin::Open(
   const FilePath &filename, AudMonkeyProject*)
{
   ...
   {
      //AudMonkey is trying to load something that is declared as
      ...
      //insdead of usual AudMonkeyMessageBox()
