...
private:
   ...
   int AddTags(AudMonkeyProject *project, ArrayOf<char> &buffer, bool *endOfFile, const Tags *tags);
#ifdef USE_LIBID3TAG
...
ProgressResult ExportMP2::Export(AudMonkeyProject *project,
   std::unique_ptr<ProgressDialog> &pDialog,
...
int ExportMP2::AddTags(
   AudMonkeyProject * WXUNUSED(project), ArrayOf< char > &buffer,
