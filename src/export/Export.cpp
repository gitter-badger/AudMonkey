...
Exporter::Exporter( AudMonkeyProject &project )
: mProject{ &project }
{
...
bool Exporter::DoEditMetadata(AudMonkeyProject &project,
...
TranslatableString AudMonkeyExportCaptionStr()
{
   return XO("Warning");
}
TranslatableString AudMonkeyExportMessageStr()
{
