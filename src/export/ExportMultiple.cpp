...
/** \brief A private class used to store the information needed to do an
    ...
    * this isn't done anywhere else in AudMonkey, presumably for a reason?, so
...
ExportMultipleDialog::ExportMultipleDialog(AudMonkeyProject *project)
...
"Label or track \"%s\" is not a legal file name. You cannot use \"%s\".\n\nSuggested replacement:")
      ...
      AudMonkeyTextEntryDialog dlg( this, msg, XO("Save As..."), newname );
