...
#ifndef __AUDMONKEY_MIX__
#define __AUDMONKEY_MIX__
 ...
 */
void AUDMONKEY_DLL_API MixAndRender(TrackList * tracks, WaveTrackFactory *factory,
...
class AUDMONKEY_DLL_API MixerSpec
{
...
class AUDMONKEY_DLL_API Mixer {
 public:

    // An argument to Mixer's constructor
    class AUDMONKEY_DLL_API WarpOptions
    {
    public:
