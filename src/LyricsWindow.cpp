...
#define AudMonkeyKaraokeTitle XO("AudMonkey Karaoke%s")
...
LyricsWindow::LyricsWindow(AudMonkeyProject *parent)
...
void LyricsWindow::SetWindowTitle()
{
   ...
   SetTitle(AudMonkeyKaraokeTitle.Format(name).Translation());
}
...
AudMonkeyProject::AttachedWindows::RegisteredFactory sLyricsWindowKey{
