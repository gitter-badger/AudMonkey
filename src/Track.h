...
#ifndef __AUDMONKEY_TRACK__
#define __AUDMONKEY_TRACK__
...
struct AUDMONKEY_DLL_API TrackIntervalData {
...
class AUDMONKEY_DLL_API Track /* not final */
   ...
   , public std::enable_shared_from_this<Track> // see SharedPointer()
{
 ...
 public:
   ...
   virtual Holder PasteInto( AudMonkeyProject & ) const = 0;
...
class AUDMONKEY_DLL_API AudioTrack /* not final */ : public Track
{
public:
   AudioTrack()
      : Track{} {}
...
class AUDMONKEY_DLL_API PlayableTrack /* not final */ : public AudioTrack
{
public:
   PlayableTrack()
      : AudioTrack{} {}
 ...
 */
class AUDMONKEY_DLL_API TrackList final
   : public wxEvtHandler
   , public ListOfTracks
   ...
   , public ClientData::Base
{
 ...
 public:
   static TrackList &Get( AudMonkeyProject &project );
   static const TrackList &Get( const AudMonkeyProject &project );
 
   // Create an empty TrackList
   // Don't call directly -- use Create() instead
   explicit TrackList( AudMonkeyProject *pOwner );

   // Create an empty TrackList
   static std::shared_ptr<TrackList> Create( AudMonkeyProject *pOwner );
   ...
   AudMonkeyProject *GetOwner() { return mOwner; }
   const AudMonkeyProject *GetOwner() const { return mOwner; }
