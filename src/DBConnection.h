...
#ifndef __AUDMONKEY_DB_CONNECTION__
#define __AUDMONKEY_DB_CONNECTION__
...
private:
   std::weak_ptr<AudMonkeyProject> mpProject;
   sqlite3 *mDB;
 ...
 */
class AUDMONKEY_DLL_API TransactionScope
{
public:
...
{
public:
   static ConnectionPtr &Get( AudMonkeyProject &project );
   static const ConnectionPtr &Get( const AudMonkeyProject &project );
