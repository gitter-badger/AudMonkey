...
#ifndef __AUDMONKEY_REGISTRY__
#define __AUDMONKEY_REGISTRY__
...
namespace Registry {
   ...
   // large.
   struct AUDMONKEY_DLL_API BaseItem {
   ...
   struct AUDMONKEY_DLL_API SharedItem final : BaseItem {
   ...
   struct AUDMONKEY_DLL_API ComputedItem final : BaseItem {
   ...
   struct AUDMONKEY_DLL_API SingleItem : BaseItem {
      using BaseItem::BaseItem;
      ~SingleItem() override = 0;
   };

   // Common abstract base class for items that group other items
   struct AUDMONKEY_DLL_API GroupItem : BaseItem {
      using BaseItem::BaseItem;
   ...
   class AUDMONKEY_DLL_API Visitor
   {
   public:
      virtual ~Visitor();
