...
TranslatableString TitleText( const wxString & Key )
{
   ...
   {
      /* i18n-hint: Title for a topic.*/
      return XO("Saving an AudMonkey Project");
   }
...
"<br><br>The version of AudMonkey you are using is an <b>Alpha test version</b>.");
   const auto betamsg = XO(
"<br><br>The version of AudMonkey you are using is a <b>Beta test version</b>.");
   ...
   if (Key == wxT("welcome"))
   {
      ...
      s
         ...
         << wxT("<hr><center><h3>")
         << XO("Get the Official Released Version of AudMonkey")
         << wxT("</h3></center>")
         << VerCheckHtml()
#ifdef IS_ALPHA
         << alphamsg
...
"We strongly recommend that you use our latest stable released version, which has full documentation and support.<br><br>")
         << XO(
"You can help us get AudMonkey ready for release by joining our [[https://www.audacityteam.org/community/|community]].<hr><br><br>")
#endif
...
// DA: Support methods text.
         ...
         << wxT("</li><li>")
         << wxT(
" email to [[mailto:james@audacityteam.org|james@audacityteam.org]] - for help using DarkAudMonkey.")
         << wxT("</li><li>")
         << wxT(
" [[http://www.darkaudacity.com/video.html|Tutorials]] - for getting started with DarkAudMonkey.")
         << wxT("</li></ul>")
         << wxT("<br><br>AudMonkey has these support methods:")
         << wxT("<ul><li>")
         << wxT(" [[https://manual.audacityteam.org/|Manual]] - for comprehensive AudMonkey documentation")
         << wxT("</li><li>")
         << wxT(" [[https://forum.audacityteam.org/|Forum]] - for large knowledge base on using AudMonkey.")
         << wxT("</li></ul>")
#else
...
" [[https://forum.audacityteam.org/|Forum]] - ask your question directly, online.")
   ...
   if(Key==wxT("wma-proprietary"))
   {
      ...
      s
         << wxT("<p>")
         << XO(
"AudMonkey can import unprotected files in many other formats (such as M4A and WMA, \
...
{
   return wxString( wxT("https://github.com/AudMonkey/AudMonkey/releases"));
}
