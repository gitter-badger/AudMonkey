...
UIHandle::Result StretchHandle::Cancel(AudMonkeyProject *pProject)
{
...
void StretchHandle::Stretch(AudMonkeyProject *pProject, int mouseXCoordinate, int trackLeftEdge,
   Track *pTrack)
{
   auto &viewInfo = ViewInfo::Get( *pProject );
