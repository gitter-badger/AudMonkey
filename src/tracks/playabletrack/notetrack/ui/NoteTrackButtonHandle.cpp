...
void NoteTrackButtonHandle::Enter(bool, AudMonkeyProject *)
{
...
(const TrackPanelMouseEvent &evt, AudMonkeyProject *pProject, wxWindow *)
{
...
UIHandle::Result NoteTrackButtonHandle::Cancel(AudMonkeyProject *)
{
   return RefreshCode::RefreshNone;
}
