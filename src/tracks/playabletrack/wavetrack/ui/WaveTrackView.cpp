...
public:
   ...
   Result Drag( const TrackPanelMouseEvent &event, AudMonkeyProject * ) override
   {
      using namespace RefreshCode;
   ...
   HitTestPreview Preview(
      const TrackPanelMouseState &state, AudMonkeyProject * ) override
   {
...
public:
   ...
   TranslatableString Tip(
      const wxMouseState &state, AudMonkeyProject &project) const override
   {
