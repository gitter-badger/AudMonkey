...
(AudMonkeyProject *pProject, float newValue)
{
...
(const wxMouseEvent &, AudMonkeyProject *pProject)
{
...
TranslatableString GainSliderHandle::Tip(
   const wxMouseState &, AudMonkeyProject &project) const
{
 ...
 const std::shared_ptr<Track> &pTrack)
{
   ...
   if (sliderRect.Contains(state.m_x, state.m_y)) {
      ...
      auto sliderFn =
      []( AudMonkeyProject *pProject, const wxRect &sliderRect, Track *pTrack ) {
...
UIHandle::Result PanSliderHandle::SetValue(AudMonkeyProject *pProject, float newValue)
{
   (void)pProject;//Compiler food
