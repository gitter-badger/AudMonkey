...
void SampleHandle::Enter(bool, AudMonkeyProject *)
{
...
(const wxMouseState &state, const AudMonkeyProject *WXUNUSED(pProject), bool unsafe)
{
...
UIHandle::Result SampleHandle::Cancel(AudMonkeyProject *pProject)
{
   mClickedTrack.reset();
