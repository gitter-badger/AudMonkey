...
void LabelDefaultClickHandle::SaveState( AudMonkeyProject *pProject )
{
...
void LabelDefaultClickHandle::RestoreState( AudMonkeyProject *pProject )
{
   if ( mLabelState ) {
...
(const TrackPanelMouseEvent &WXUNUSED(evt), AudMonkeyProject *WXUNUSED(pProject))
{
...
UIHandle::Result LabelDefaultClickHandle::Cancel(AudMonkeyProject *pProject)
{
