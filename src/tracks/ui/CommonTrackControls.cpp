...
(const TrackPanelMouseState &st,
 const AudMonkeyProject *WXUNUSED(project))
{
...
// An example of using an AudMonkeyCommand simply to create a dialog.
...
class SetTrackNameCommand : public AudMonkeyCommand
{
public:
...
void TrackMenuTable::OnSetName(wxCommandEvent &)
{
   ...
   if (pTrack)
   {
      AudMonkeyProject *const proj = &mpData->project;
...
unsigned CommonTrackControls::DoContextMenu(
   const wxRect &rect, wxWindow *pParent, wxPoint *, AudMonkeyProject *pProject)
{
