...
(const wxMouseEvent &, AudMonkeyProject *pProject, wxWindow*)
{
...
TranslatableString MinimizeButtonHandle::Tip(
   const wxMouseState &, AudMonkeyProject &) const
{
...
(const wxMouseEvent &event, AudMonkeyProject *pProject, wxWindow*)
{
   using namespace RefreshCode;
...
(const wxMouseEvent &, AudMonkeyProject *pProject, wxWindow *WXUNUSED(pParent))
{
