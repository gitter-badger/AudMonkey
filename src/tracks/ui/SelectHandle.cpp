...
void SelectHandle::Enter(bool, AudMonkeyProject *project)
{
   SetUseSnap(true, project);
}

void SelectHandle::SetUseSnap(bool use, AudMonkeyProject *project)
{
   mUseSnap = use;
...
bool SelectHandle::Escape(AudMonkeyProject *project)
{
...
(const TrackPanelMouseState &st, AudMonkeyProject *pProject)
{
   if (!HasSnap() && !mUseSnap)
...
(const TrackPanelMouseEvent &, AudMonkeyProject *pProject,
 wxWindow *)
{
   using namespace RefreshCode;
   ProjectHistory::Get( *pProject ).ModifyState(false);
...
UIHandle::Result SelectHandle::Cancel(AudMonkeyProject *pProject)
{
   mSelectionStateChanger.reset();
...
void SelectHandle::Connect(AudMonkeyProject *pProject)
{
...
{
public:
   TimerHandler( SelectHandle *pParent, AudMonkeyProject *pProject )
      : mParent{ pParent }
...
private:
   ...
   AudMonkeyProject *mConnectedProject;
};
...
void SelectHandle::StartSelection( AudMonkeyProject *pProject )
{
   auto &viewInfo = ViewInfo::Get( *pProject );
   mSelStartValid = true;
