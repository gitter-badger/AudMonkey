...
HitTestPreview ZoomHandle::HitPreview
   (const wxMouseState &state, const AudMonkeyProject *WXUNUSED(pProject))
{
...
(const TrackPanelMouseEvent &evt, AudMonkeyProject *)
{
...
UIHandle::Result ZoomHandle::Cancel(AudMonkeyProject*)
{
