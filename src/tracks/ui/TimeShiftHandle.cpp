...
void TimeShiftHandle::Enter(bool, AudMonkeyProject *)
{
...
(const AudMonkeyProject *WXUNUSED(pProject), bool unsafe)
{
...
template<> auto MakeTrackShifter::Implementation() -> Function {
   return [](Track &track, AudMonkeyProject&) {
...
UIHandle::Result TimeShiftHandle::Cancel(AudMonkeyProject *pProject)
{
