...
PlayIndicatorOverlayBase::PlayIndicatorOverlayBase(AudMonkeyProject *project, bool isMaster)
: mProject(project)
, mIsMaster(isMaster)
{
}
...
PlayIndicatorOverlay::PlayIndicatorOverlay(AudMonkeyProject *project)
