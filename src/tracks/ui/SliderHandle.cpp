...
void SliderHandle::Enter(bool, AudMonkeyProject *)
{
...
(const TrackPanelMouseState &st, AudMonkeyProject *project)
{
   // No special cursor
...
UIHandle::Result SliderHandle::Cancel(AudMonkeyProject *pProject)
{
...
LWSlider *SliderHandle::GetSlider( AudMonkeyProject *pProject )
{
