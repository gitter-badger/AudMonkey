...
public:
   explicit
   ScrubbingOverlay(AudMonkeyProject *project);
...
ScrubbingOverlay::ScrubbingOverlay(AudMonkeyProject *project)
   : mProject(project)
   , mLastScrubRect()
   , mNextScrubRect()
   , mLastScrubSpeedText()
...
static const AudMonkeyProject::AttachedObjects::RegisteredFactory sOverlayKey{
...
struct ScrubForwarder
    ...
    , public ClientData::Base
{
   ScrubForwarder( AudMonkeyProject &project )
      : mProject{ project }
   {
...
static const AudMonkeyProject::AttachedObjects::RegisteredFactory sForwarderKey{
   []( AudMonkeyProject &parent ){
