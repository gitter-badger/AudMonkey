...
(const TrackPanelMouseState &, AudMonkeyProject *project)
{
...
(const TrackPanelMouseEvent &, AudMonkeyProject *project, wxWindow *)
{
...
UIHandle::Result TrackSelectHandle::Cancel(AudMonkeyProject *pProject)
{
