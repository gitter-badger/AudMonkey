...
using AudMonkeyCommandMap = std::unordered_map<wxString, AudMonkeyCommand *>;
...
public:
   ...
   bool DoAudMonkeyCommand(const PluginID & ID,
...
private:
   AudMonkeyCommand *GetAudMonkeyCommand(const PluginID & ID);

   EffectMap mEffects;
   AudMonkeyCommandMap mCommands;
