...
EffectRack::EffectRack( AudMonkeyProject &project )
...
EffectRack &EffectRack::Get( AudMonkeyProject &project )
{
...
{
   // may throw
   // exceptions are handled in AudMonkeyApp::OnExceptionInMainLoop
