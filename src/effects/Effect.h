...
#ifndef __AUDMONKEY_EFFECT__
#define __AUDMONKEY_EFFECT__
...
/* i18n-hint: "Nyquist" is an embedded interpreted programming language in
 AudMonkey, named in honor of the Swedish-American Harry Nyquist (or Nyqvist).
...
class AUDMONKEY_DLL_API Effect /* not final */ : public wxEvtHandler,
...
protected:
   ...
   class AUDMONKEY_DLL_API AddedAnalysisTrack {
      friend Effect;
   ...
   class AUDMONKEY_DLL_API ModifiedAnalysisTrack {
      friend Effect;
...
protected:
   ...
   const AudMonkeyProject *FindProject() const;
