...
from there.  AudMonkey will look for a file called "Pause.png".
...
#define LOGOWITHNAME_HEIGHT 200
   ...
   SET_THEME_FLAGS( resFlagNewLine );
   DEFINE_IMAGE( bmpAudMonkeyLogo48x48, wxImage( 48, 48 ), wxT("AudMonkeyLogo48x48"));
