...
void DoRemoveTracks( AudMonkeyProject &project )
{
...
void DoTrackMute(AudMonkeyProject &project, Track *t, bool exclusive)
{
...
void DoTrackSolo(AudMonkeyProject &project, Track *t, bool exclusive)
{
   const auto &settings = ProjectSettings::Get( project );
   auto &tracks = TrackList::Get( project );
