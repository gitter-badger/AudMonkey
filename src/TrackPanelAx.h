...
{
public:
   TrackPanelAx(AudMonkeyProject &project);
...
{
public:
   static TrackFocus &Get( AudMonkeyProject &project );
   static const TrackFocus &Get( const AudMonkeyProject &project );

   explicit TrackFocus( AudMonkeyProject &project );
   ~TrackFocus() override;
