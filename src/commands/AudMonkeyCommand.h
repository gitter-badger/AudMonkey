...
#include "../include/audmonkey/EffectAutomationParameters.h" // for command automation

#include "../Registrar.h"

class ShuttleGui;

#define BUILTIN_GENERIC_COMMAND_PREFIX wxT("Built-in AudMonkeyCommand: ")
                                ...
                                public ComponentInterface
{
 ...
 public:
   ...
   // Name of page in the AudMonkey alpha manual
   ...
   wxDialog *CreateUI(wxWindow *parent, AudMonkeyCommand *client);

   virtual bool GetAutomationParameters(wxString & parms);
   virtual bool SetAutomationParameters(const wxString & parms);

   bool DoAudMonkeyCommand(wxWindow *parent, const CommandContext & context,bool shouldPrompt = true);
...
//
// Each subclass of AudMonkeyCommand overrides one or more of these methods to
// do its processing.
//
//protected:
   ...
   virtual bool CheckWhetherSkipAudMonkeyCommand() { return false; }
...
public:
   ...
   AudMonkeyCommandDialog(wxWindow * parent,
...
private:
   ...
   AudMonkeyCommand * mpCommand;

   DECLARE_EVENT_TABLE()
   wxDECLARE_NO_COPY_CLASS(AudMonkeyCommandDialog);
};
