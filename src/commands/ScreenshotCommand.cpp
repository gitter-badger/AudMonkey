...
ScreenshotCommand::ScreenshotCommand()
{
   ...
   std::call_once( flag, []{
      AudMonkeyCommand::SetVetoDialogHook( MayCapture );
...
static AudMonkeyProject *pIdleHandlerProject = nullptr;
...
void ScreenshotCommand::SetIdleHandler( AudMonkeyProject &project )
{
   mIdleHandler = IdleHandler;
   pIdleHandlerProject = &project;
}

wxTopLevelWindow *ScreenshotCommand::GetFrontWindow(AudMonkeyProject *project)
{
   wxWindow *front = NULL;
...
void ScreenshotCommand::CapturePreferences( 
   const CommandContext & context,
   AudMonkeyProject * pProject, const wxString &FileName ){
...
void ScreenshotCommand::CaptureCommands( 
   ...
   AudMonkeyProject * pProject = &context.project;
...
wxRect ScreenshotCommand::GetTrackRect( AudMonkeyProject * pProj, TrackPanel * panel, int n){
...
wxString ScreenshotCommand::WindowFileName(AudMonkeyProject * proj, wxTopLevelWindow *w){
