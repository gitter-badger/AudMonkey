...
AudMonkeyCommand and a shuttle system.  This allows commands to be used
...
and Name, but that is now replaced by the AudMonkeyCommand interface.  
...
CommandImplementation::CommandImplementation(
  AudMonkeyProject &project, OldStyleCommandType &type)
