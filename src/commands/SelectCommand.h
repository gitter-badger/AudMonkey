...
class SelectTimeCommand : public AudMonkeyCommand
{
public:
...
class SelectFrequenciesCommand : public AudMonkeyCommand
{
public:
   static const ComponentInterfaceSymbol Symbol;
...
class SelectTracksCommand : public AudMonkeyCommand
{
public:
   static const ComponentInterfaceSymbol Symbol;
...
class SelectCommand : public AudMonkeyCommand
{
public:
   static const ComponentInterfaceSymbol Symbol;
