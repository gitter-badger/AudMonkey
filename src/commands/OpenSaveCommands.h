...
\brief Command for opening an AudMonkey project

\class SaveProjectCommand
\brief Command for saving an AudMonkey project
...
class OpenProjectCommand : public AudMonkeyCommand
{
public:
...
class SaveProjectCommand : public AudMonkeyCommand
{
public:
   static const ComponentInterfaceSymbol Symbol;
...
class SaveCopyCommand : public AudMonkeyCommand
{
public:
   static const ComponentInterfaceSymbol Symbol;
...
class SaveLogCommand : public AudMonkeyCommand
{
public:
   static const ComponentInterfaceSymbol Symbol;
...
class ClearLogCommand : public AudMonkeyCommand
{
public:
   static const ComponentInterfaceSymbol Symbol;
