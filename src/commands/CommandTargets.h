...
class AUDMONKEY_DLL_API CommandMessageTarget /* not final */
{
public:
...
/// Displays messages from a command in an AudMonkeyMessageBox
class AUDMONKEY_DLL_API MessageBoxTarget final : public CommandMessageTarget
{
public:
...
class AUDMONKEY_DLL_API StatusBarTarget final : public CommandMessageTarget
{
private:
   wxStatusBar &mStatus;
public:
...
class AUDMONKEY_DLL_API LispifiedCommandOutputTargets
...
class AUDMONKEY_DLL_API BriefCommandOutputTargets : public CommandOutputTargets
{
public :
