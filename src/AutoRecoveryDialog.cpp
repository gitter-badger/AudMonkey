...
{
public:
   explicit AutoRecoveryDialog(AudMonkeyProject *proj);
...
private:
   ...
   void OnQuitAudMonkey(wxCommandEvent &evt);
...
AutoRecoveryDialog::AutoRecoveryDialog(AudMonkeyProject *project)
...
void AutoRecoveryDialog::PopulateOrExchange(ShuttleGui &S)
{
   ...
   {
      S.AddFixedText(
         XO("The following projects were not saved properly the last time AudMonkey was run and "
...
bool AutoRecoveryDialog::HaveChecked()
{
   ...
   AudMonkeyMessageBox(XO("No projects selected"), XO("Automatic Crash Recovery"));
...
bool ShowAutoRecoveryDialogIfNeeded(AudMonkeyProject *&pproj, bool *didRecoverAnything)
{
