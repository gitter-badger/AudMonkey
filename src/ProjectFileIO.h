...
public:
   ...
   static ProjectFileIO &Get( AudMonkeyProject &project );
   static const ProjectFileIO &Get( const AudMonkeyProject &project );

   explicit ProjectFileIO( AudMonkeyProject &project );
...
class TitleRestorer{
public:
   TitleRestorer( wxTopLevelWindow &window, AudMonkeyProject &project );
   ~TitleRestorer();
...
private:
   std::shared_ptr<AudMonkeyProject> mpProject;
};
