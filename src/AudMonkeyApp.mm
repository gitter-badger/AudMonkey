...
// Mac-only methods of class AudMonkeyApp that use Objective-C are kept
// here so that AudMonkeyApp.cpp can be just C++
...
void AudMonkeyApp::MacActivateApp()
{
...
void AudMonkeyApp::MacFinishLaunching()
{
