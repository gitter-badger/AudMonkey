...
an AudMonkey .aup file rather than AudMonkey having its own copies of the
data.

*//*****************************************************************//**

\class DependencyDialog
\brief DependencyDialog shows dependencies of an AudMonkeyProject on 
AliasedFile s.
...
static void GetAllSeqBlocks(AudMonkeyProject *project,
...
// Given an AudMonkey project and a hash mapping aliased block
...
void FindDependencies(AudMonkeyProject *project,
...
static void RemoveDependencies(AudMonkeyProject *project,
         ...
         S.StartHorizontalLay(wxALIGN_LEFT,0);
         {
            mFutureActionChoice =
               S.Id(FutureActionChoiceID).AddChoice(
                  ...
                  {
                     /*i18n-hint: One of the choices of what you want AudMonkey to do when
                     * AudMonkey finds a project depends on another file.*/
                     XO("Ask me") ,
                     /*i18n-hint: One of the choices of what you want AudMonkey to do when
                     * AudMonkey finds a project depends on another file.*/
...
bool ShowDependencyDialogIfNeeded(AudMonkeyProject *project,
                                  bool isSaving)
{
...
\n\nSome older AudMonkey projects may not be self-contained, and care \n\
