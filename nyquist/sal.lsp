...
;; a function named MAIN. This is a shorthand for AudMonkey plug-ins
;;
(defun sal-compile-audmonkey (input eval-flag multiple-statements filename)
  (progv '(*audmonkey-top-level-return-flag*) '(t)
