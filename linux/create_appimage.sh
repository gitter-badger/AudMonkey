...
readonly appdir="$1" # input path (AudMonkey install directory)
...
ln -sf share/applications/audmonkey.desktop "${appdir}/audmonkey.desktop"
ln -sf share/icons/hicolor/scalable/apps/audmonkey.svg "${appdir}/audmonkey.svg"
ln -sf share/icons/hicolor/scalable/apps/audmonkey.svg "${appdir}/.DirIcon"
...
export LD_LIBRARY_PATH="${appdir}/usr/lib/audmonkey:${LD_LIBRARY_PATH-}"
