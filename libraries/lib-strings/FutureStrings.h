...
the translation catalog template, locale/audmonkey.pot, to stabilize long enough
...
XC("Update AudMonkey", "update dialog"),
...
XC("AudMonkey %s is available!", "update dialog"),
